...
export const SCREENS = {
  ...
  sampleCollection: {
    ...
    moduleKey: "sampleCollection",
    screenName: "Sample Collection Worklist",
    workflowRef: "Confirmed → Pending Collection → Collected",
  },
  labOrderList: {
    route: "/lab/orders",
    moduleKey: "sampleCollection",
    screenName: "Lab Orders",
    workflowRef: "Draft → Confirmed → Sample lifecycle",
  },
  labOrderNew: {
    route: "/lab/orders/new",
    moduleKey: "sampleCollection",
    screenName: "Create Lab Order",
    workflowRef: "Manual or source-linked order creation",
  },
  labOrderDetail: {
    route: "/lab/orders/[orderId]",
    moduleKey: "sampleCollection",
    screenName: "Lab Order Detail",
    workflowRef: "Order summary and workflow actions",
  },
  labOrderEdit: {
    route: "/lab/orders/[orderId]/edit",
    moduleKey: "sampleCollection",
    screenName: "Edit Lab Order",
    workflowRef: "Draft order editing",
  },
  labOrderCollect: {
    route: "/lab/orders/[orderId]/collect",
    moduleKey: "sampleCollection",
    screenName: "Sample Collection",
    workflowRef: "Collect samples for order",
  },
  labCollectionWorklist: {
    route: "/lab/collection",
    moduleKey: "sampleCollection",
    screenName: "Collection Worklist",
    workflowRef: "Pending collection queue",
  },
  labReceiptWorklist: {
    route: "/lab/receipt",
    moduleKey: "sampleCollection",
    screenName: "Sample Receipt",
    workflowRef: "Collected → Received or Rejected",
  },
  labProcessingWorklist: {
    route: "/lab/processing",
    moduleKey: "sampleCollection",
    screenName: "Sample Processing",
    workflowRef: "Received → Ready for result",
  },
  labSampleDetail: {
    route: "/lab/samples/[sampleId]",
    moduleKey: "sampleCollection",
    screenName: "Sample Detail",
    workflowRef: "Sample lifecycle audit trail",
  },
  labSampleLabel: {
    route: "/lab/samples/[sampleId]/label",
    moduleKey: "sampleCollection",
    screenName: "Sample Label",
    workflowRef: "Print accession barcode label",
  },
  labelPrint: {
