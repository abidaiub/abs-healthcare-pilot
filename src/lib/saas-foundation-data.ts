...
export const MODULE_REGISTRY: ModuleRegistryEntry[] = [
  ...
  { moduleCode: "MOD-24", moduleName: "Report Release & Delivery", displayName: "Report Release & Delivery", moduleGroup: "Diagnostic Foundation", coreModule: false, status: "Active", description: "Report authorization, print/PDF, portal handoff, QR verification, and amendment workflow", implementationStatus: "Implemented", dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15", "MOD-21", "MOD-22", "MOD-23"], capabilities: ["Release queue", "Release authorization", "Report numbering", "Immutable snapshot versions", "HTML printable report", "Server PDF generation", "Reprint audit", "Portal publish flag", "QR verification", "Withdrawal", "Amendment workflow", "Release history", "RBAC", "Audit logging", "Localization", "RTL support", "Registry compliance"], supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"], verifyCommand: "npm run verify:mod24", docPath: "docs/modules/MOD-24-Report-Release-Delivery.md", aiQcReportPath: "docs/AI-QC/reports/024-Report-Release-Delivery-AI-QC-v1.0.md", manualQcGuidePath: "docs/AI-QC/manual-qc/source/024-Report-Release-Delivery-Manual-QC-v1.0.md", manualQcResultTemplatePath: "docs/AI-QC/manual-qc/results/024-Report-Release-Delivery-Manual-QC-Result-Template.md", automatedQcStatus: "PASS", manualQcStatus: "NOT TESTED", browserUatStatus: "NOT TESTED", productionApprovalStatus: "Pending Manual QC" },
