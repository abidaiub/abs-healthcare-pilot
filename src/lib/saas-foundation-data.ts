...
export const SAAS_TENANTS: SaasTenant[] = [
  ...
  },
  {
    ...
    modules: ABMG_MODULES.map((m) => ({
      ...m,
      enabled: m.moduleCode.startsWith("MOD-0") || m.moduleCode === "MOD-10" || m.moduleCode === "MOD-15" || m.moduleCode === "MOD-17" || m.moduleCode === "MOD-18" || m.moduleCode === "MOD-19" || m.moduleCode === "MOD-20",
      status: m.moduleCode.startsWith("MOD-0") || m.moduleCode === "MOD-10" || m.moduleCode === "MOD-15" || m.moduleCode === "MOD-17" || m.moduleCode === "MOD-18" || m.moduleCode === "MOD-19" || m.moduleCode === "MOD-20" ? "Trial" as const : "Disabled" as const,
    })),
    statusHistory: [
