...
export type ModuleRegistryEntry = {
  ...
  moduleName: string;
  displayName?: string;
  /** Numeric module id without MOD- prefix (e.g. "33"). */
  numericId?: string;
  moduleGroup: string;
  coreModule: boolean;
  /**
   * Registry lifecycle status.
   * Planned Business Operations modules use "Inactive" so they are reserved
   * without being tenant-enabled or route-activated.
   */
  status: "Active" | "Inactive" | "Deprecated";
  description: string;
  implementationStatus?: "Implemented" | "Planned" | "Deprecated";
  /** Documentation reservation maturity (not an implementation claim). */
  documentationStatus?: "ARCHITECTURE APPROVED" | "PLANNED";
  /** Planned edition packaging labels (informational only). */
  editionAvailability?: string[];
  dependencies?: string[];
  capabilities?: string[];
...
const ABMG_MODULES: TenantModuleAssignment[] = [
  ...
  { moduleCode: "MOD-07", moduleName: "Branch / Location Management", moduleGroup: "Foundation", enabled: true, status: "Active", enabledFrom: "01-Jan-2026", enabledTo: "—", coreModule: true },
  ...
  { moduleCode: "MOD-17", moduleName: "OPD / Appointments", moduleGroup: "Clinical", enabled: true, status: "Active", enabledFrom: "01-Jan-2026", enabledTo: "—", coreModule: false },
  { moduleCode: "MOD-21", moduleName: "Sample Collection & Lab Workflow", moduleGroup: "Diagnostic", enabled: true, status: "Active", enabledFrom: "01-Jan-2026", enabledTo: "—", coreModule: false },
...
export const SAAS_TENANTS: SaasTenant[] = [
  ...
  },
  {
    ...
    modules: ABMG_MODULES.map((m) => ({
      ...m,
      enabled: m.moduleCode.startsWith("MOD-0") || m.moduleCode === "MOD-10" || m.moduleCode === "MOD-15" || m.moduleCode === "MOD-17" || m.moduleCode === "MOD-18" || m.moduleCode === "MOD-19" || m.moduleCode === "MOD-20" || m.moduleCode === "MOD-21",
      status: m.moduleCode.startsWith("MOD-0") || m.moduleCode === "MOD-10" || m.moduleCode === "MOD-15" || m.moduleCode === "MOD-17" || m.moduleCode === "MOD-18" || m.moduleCode === "MOD-19" || m.moduleCode === "MOD-20" || m.moduleCode === "MOD-21" ? "Trial" as const : "Disabled" as const,
    })),
    statusHistory: [
...
export const MODULE_REGISTRY: ModuleRegistryEntry[] = [
  ...
  {
    moduleCode: "MOD-07",
    moduleName: "Branch / Location Management",
    displayName: "Branch Management",
    moduleGroup: "Foundation",
    coreModule: true,
    status: "Active",
    description: "Tenant-isolated branch management, assignments, and working context",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06"],
    capabilities: [
      ...
      "Secure current branch resolution",
      "Branch switching",
      "RBAC",
      "Audit logs",
      "Localization",
    ...
    verifyCommand: "npm run verify:mod07",
    docPath: "docs/modules/MOD-07-Branch-Location-Management.md",
    aiQcReportPath: "docs/AI-QC/reports/007-Branch-Location-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/007-Branch-Location-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/007-Branch-Location-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  ...
  {
    moduleCode: "MOD-15",
    moduleName: "Patient Registration / Patient Master",
    displayName: "Patient Registration",
    moduleGroup: "Clinical Foundation",
    coreModule: false,
    status: "Active",
    description: "Tenant-isolated patient master, registration, duplicate detection, and lifecycle",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07"],
    capabilities: [
      "Tenant-isolated Patient Master",
      "Branch-aware registration",
      "Patient number generation",
      "Demographics",
      "DOB and estimated-age handling",
      "Contact and address",
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    verifyCommand: "npm run verify:mod15",
    docPath: "docs/modules/MOD-15-Patient-Registration.md",
    aiQcReportPath: "docs/AI-QC/reports/015-Patient-Registration-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/015-Patient-Registration-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/015-Patient-Registration-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  ...
  {
    moduleCode: "MOD-17",
    moduleName: "Appointment & Queue Management",
    displayName: "Appointment & Queue",
    moduleGroup: "Clinical Foundation",
    coreModule: false,
    status: "Active",
    description: "OPD appointments, scheduling, and branch doctor queue management",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15"],
    capabilities: [
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    verifyCommand: "npm run verify:mod17",
    docPath: "docs/modules/MOD-17-Appointment-Queue-Management.md",
    aiQcReportPath: "docs/AI-QC/reports/017-Appointment-Queue-Management-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/017-Appointment-Queue-Management-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/017-Appointment-Queue-Management-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  ...
  {
    moduleCode: "MOD-18",
    moduleName: "Doctor Worklist & Clinical Encounter",
    displayName: "Doctor Consultation",
    moduleGroup: "Clinical Foundation",
    coreModule: false,
    status: "Active",
    description: "Clinical encounter workspace, vitals, diagnosis, medicine and investigation advice",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15", "MOD-17"],
    capabilities: [
      "Clinical encounter lifecycle",
      "Appointment-linked consultation start",
      "Tenant-isolated encounters",
      "Branch-persisted encounter context",
      "Vitals capture",
      "Diagnosis recording",
      "Medicine advice",
      "Investigation advice",
      "Consultation print summary",
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    verifyCommand: "npm run verify:mod18",
    docPath: "docs/modules/MOD-18-Doctor-Consultation.md",
    aiQcReportPath: "docs/AI-QC/reports/018-Doctor-Consultation-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/018-Doctor-Consultation-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/018-Doctor-Consultation-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  },
  {
    ...
    coreModule: false,
    status: "Active",
    description: "Structured prescription drafting, finalization, printing, and version history",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15", "MOD-17", "MOD-18"],
    capabilities: [
      "Encounter-linked prescription creation",
      "Tenant-isolated prescriptions",
      "Branch-persisted prescription context",
      "Encounter snapshot sync",
      "Structured medicine lines",
      "Diagnosis and investigation snapshot",
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    verifyCommand: "npm run verify:mod19",
    docPath: "docs/19-PrescriptionManagement/PrescriptionManagement_v1.md",
    aiQcReportPath: "docs/AI-QC/reports/019-Prescription-Management-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/019-Prescription-Management-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/019-Prescription-Management-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  ...
  {
    moduleCode: "MOD-20",
    moduleName: "Pharmacy & Medication Catalog",
    displayName: "Pharmacy & Medication Catalog",
    moduleGroup: "Clinical Foundation",
    coreModule: false,
    status: "Active",
    description: "Tenant medication catalog, generics, manufacturers, and prescription lookup foundation",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-18", "MOD-19"],
    capabilities: [
      "Tenant medication catalog",
      "Generic and brand distinction",
      "Combination ingredient support",
      "Manufacturer master",
      "Dosage form and route reference",
      "Medication code allocation",
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    verifyCommand: "npm run verify:mod20",
    docPath: "docs/modules/MOD-20-Pharmacy-Medication-Catalog.md",
    aiQcReportPath: "docs/AI-QC/reports/020-Pharmacy-Medication-Catalog-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/020-Pharmacy-Medication-Catalog-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/020-Pharmacy-Medication-Catalog-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  ...
  {
    moduleCode: "MOD-21",
    moduleName: "Sample Collection & Lab Workflow",
    displayName: "Sample Collection & Lab Workflow",
    moduleGroup: "Diagnostic Foundation",
    coreModule: false,
    status: "Active",
    description: "Lab order creation, sample collection, receipt, rejection, and processing workflow",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15", "MOD-18", "MOD-19"],
    capabilities: [
      "Lab order lifecycle",
      "Encounter and prescription sourcing",
      "Manual lab orders",
      "Specimen grouping",
      "Accession numbering",
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    verifyCommand: "npm run verify:mod21",
    docPath: "docs/modules/MOD-21-Sample-Collection-Lab-Workflow.md",
    aiQcReportPath: "docs/AI-QC/reports/021-Sample-Collection-Lab-Workflow-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/021-Sample-Collection-Lab-Workflow-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/021-Sample-Collection-Lab-Workflow-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  ...
  {
    moduleCode: "MOD-22",
    moduleName: "Laboratory Result Entry",
    displayName: "Laboratory Result Entry",
    moduleGroup: "Diagnostic Foundation",
    coreModule: false,
    status: "Active",
    description: "Manual result entry, parameter validation, reference ranges, abnormal flags, and critical value workflow",
    implementationStatus: "Implemented",
    dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15", "MOD-21"],
    capabilities: [
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    verifyCommand: "npm run verify:mod22",
    docPath: "docs/modules/MOD-22-Laboratory-Result-Entry.md",
    aiQcReportPath: "docs/AI-QC/reports/022-Laboratory-Result-Entry-AI-QC-v1.0.md",
    manualQcGuidePath: "docs/AI-QC/manual-qc/source/022-Laboratory-Result-Entry-Manual-QC-v1.0.md",
    manualQcResultTemplatePath:
      "docs/AI-QC/manual-qc/results/022-Laboratory-Result-Entry-Manual-QC-Result-Template.md",
    automatedQcStatus: "PASS",
    manualQcStatus: "NOT TESTED",
    browserUatStatus: "NOT TESTED",
    productionApprovalStatus: "Pending Manual QC",
  },
  { moduleCode: "MOD-23", moduleName: "Result Verification & Approval", displayName: "Pathologist Verification", moduleGroup: "Diagnostic Foundation", coreModule: false, status: "Active", description: "Pathologist verification, rejection for correction, and technician resubmit workflow", implementationStatus: "Implemented", dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15", "MOD-21", "MOD-22"], capabilities: ["Verification worklist", "Pathologist review and approval", "Rejection for correction", "Correction worklist", "Technician resubmit", "Verification history", "Self-approval override governance", "RBAC", "Audit logging", "Localization", "RTL support", "Registry compliance"], supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"], verifyCommand: "npm run verify:mod23", docPath: "docs/modules/MOD-23-Pathologist-Verification.md", aiQcReportPath: "docs/AI-QC/reports/023-Pathologist-Verification-AI-QC-v1.0.md", manualQcGuidePath: "docs/AI-QC/manual-qc/source/023-Pathologist-Verification-Manual-QC-v1.0.md", manualQcResultTemplatePath: "docs/AI-QC/manual-qc/results/023-Pathologist-Verification-Manual-QC-Result-Template.md", automatedQcStatus: "PASS", manualQcStatus: "NOT TESTED", browserUatStatus: "NOT TESTED", productionApprovalStatus: "Pending Manual QC" },
  { moduleCode: "MOD-24", moduleName: "Report Release & Delivery", displayName: "Report Release & Delivery", moduleGroup: "Diagnostic Foundation", coreModule: false, status: "Active", description: "Report authorization, blocking matrix, print/PDF with QR, portal handoff, and amendment workflow (release-polish migration ordering repaired via deferred idempotent apply; migration fix verified on fresh DB, QC redeployment pending)", implementationStatus: "Implemented", dependencies: ["MOD-01", "MOD-01A", "MOD-02", "MOD-03", "MOD-04", "MOD-06", "MOD-07", "MOD-15", "MOD-21", "MOD-22", "MOD-23"], capabilities: ["Release queue", "Centralized release blocking matrix", "Release authorization", "Billing hold foundation", "Quality hold governance", "Critical acknowledgment policy", "Report numbering", "Immutable snapshot versions", "HTML printable report with QR", "Server PDF generation with QR", "Reprint audit", "Portal publish flag", "QR verification", "Withdrawal", "Amendment workflow", "Release history", "RBAC", "Audit logging", "Localization", "RTL support", "Registry compliance"], supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"], verifyCommand: "npm run verify:mod24", docPath: "docs/modules/MOD-24-Report-Release-Delivery.md", aiQcReportPath: "docs/AI-QC/reports/024-Report-Release-Delivery-AI-QC-v1.1.md", manualQcGuidePath: "docs/AI-QC/manual-qc/source/024-Report-Release-Delivery-Manual-QC-v1.1.md", manualQcResultTemplatePath: "docs/AI-QC/manual-qc/results/024-Report-Release-Delivery-Manual-QC-Result-Template-v1.1.md", automatedQcStatus: "PASS", manualQcStatus: "NOT TESTED", browserUatStatus: "NOT TESTED", productionApprovalStatus: "Pending Manual QC" },
  ...
  // --- Business Operations Suite (P0 documentation reservation) ---
  // status Inactive = reserved in registry only; not tenant-enabled; no routes.
  {
    moduleCode: "MOD-33",
    numericId: "33",
    moduleName: "Finance & General Accounting",
    displayName: "Finance & General Accounting",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "Central double-entry accounting engine: fiscal years, periods, COA, vouchers, posting/reversal, GL, cash/bank, statements, party subledgers",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Diagnostic:Optional-Recommended",
      "Clinic/Hospital:Recommended",
      "Trading/Distribution:Required",
    ...
    capabilities: [
      ...
      "Period lock",
      "Chart of Accounts and control account roles",
      "Opening balances",
      "Journal / receipt / payment / contra / adjustment vouchers",
      "Central posting engine",
      "Voucher reversal",
      "General Ledger and account ledger",
      "Cash Book and Bank Book",
      "Bank reconciliation",
      "Trial Balance, P&L, Balance Sheet, Cash Flow, Changes in Equity",
      "Generic party/subledger integration",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-33-Finance-General-Accounting.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
  ...
  },
  {
    ...
    status: "Inactive",
    description:
      "Supplier master, requisition-to-PO, GRN orchestration, three-way matching, supplier invoice/payment, VAT, freight, landed cost",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Diagnostic:Optional",
    ...
    capabilities: [
      ...
      "Purchase order and partial receiving",
      "GRN orchestration and inspection",
      "Supplier invoice and three-way matching",
      "Purchase return, advance, and payment",
      "Tax/VAT, freight, landed cost",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-34-Procurement-Supplier-Management.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
  },
  {
    moduleCode: "MOD-35",
    numericId: "35",
    moduleName: "Enterprise Inventory, Store & Consumption",
    displayName: "Enterprise Inventory, Store & Consumption",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "Single generic inventory engine: items, UOM, warehouses, batch/expiry/serial, stock movements, valuation (WAVG/FIFO), item ledger",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
    ...
    capabilities: [
      ...
      "Category and UOM conversion",
      "Warehouse / central store / department store",
      "Batch, expiry, serial, barcode",
      "Stock receipt, transfer, issue, return, consumption",
      "Wastage, damage, physical count, adjustment, reorder",
      "Weighted average and optional FIFO valuation",
      "Item ledger",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-35-Enterprise-Inventory.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
  },
  {
    moduleCode: "MOD-36",
    numericId: "36",
    moduleName: "Fixed Asset, Device Maintenance & Calibration",
    displayName: "Fixed Asset, Device Maintenance & Calibration",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "Asset register, capitalization, depreciation, assignment, maintenance, calibration, AMC, downtime, disposal/sale/write-off",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Diagnostic:Optional",
      "Clinic/Hospital:Recommended",
      "Trading/Distribution:Optional",
    ...
    capabilities: [
      ...
      "Tagging, assignment, location, custodian",
      "Depreciation and transfer",
      "Maintenance, calibration, warranty, AMC",
      "Breakdown, spare parts, downtime",
      "Disposal, sale, write-off",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-36-Fixed-Asset-Maintenance.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
  },
  {
    ...
    displayName: "HR & Employee Management",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "Employee master and employment lifecycle: designation, attendance, shift, roster, leave, overtime, transfer, promotion, separation",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Diagnostic:Optional",
    ...
    capabilities: [
      "Employee master and employment lifecycle",
      "Department link, designation, position",
      "Attendance, shift, roster, leave, overtime",
      "Transfer, promotion, document expiry, separation",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-37-HR-Employee-Management.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
  },
  {
    moduleCode: "MOD-38",
    numericId: "38",
    moduleName: "Payroll, Benefits, Loans & Final Settlement",
    displayName: "Payroll, Benefits, Loans & Final Settlement",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "Salary structures, earnings/deductions, loans/advances, tax/PF, payroll run/approval, MOD-33 posting, payslip, final settlement",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Diagnostic:Optional",
    ...
    capabilities: [
      "Salary structure and earning/deduction components",
      "Overtime, loan, advance, installment",
      "Tax and provident fund",
      "Payroll run, validation, approval",
      "Accounting posting via MOD-33",
      "Salary payment, payslip, final settlement",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-38-Payroll-Benefits-Settlement.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
  },
  {
    moduleCode: "MOD-39",
    numericId: "39",
    moduleName: "Shareholder, Investment & Profit Distribution",
    displayName: "Shareholder, Investment & Profit Distribution",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "Shareholder register, capital movements, distributable profit, dividend declaration/payment, unpaid dividend, reversal history",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Diagnostic:Optional",
    ...
    capabilities: [
      "Shareholder register and share classes",
      "Ownership percentage and capital contribution",
      "Share transfer, shareholder loan, capital withdrawal",
      "Retained earnings and distributable profit",
      "Dividend declaration, payable, payment, unpaid dividend",
      "Ownership snapshot, tax deduction, reversal",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-39-Shareholder-Profit-Distribution.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
  },
  {
    moduleCode: "MOD-41",
    numericId: "41",
    moduleName: "Budgeting, Cost Center & Financial Control",
    displayName: "Budgeting, Cost Center & Financial Control",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "Cost centers, projects, annual/branch/department/project budgets, commitment control, actual vs budget, approval limits, cash-flow forecast",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Diagnostic:Optional",
      "Clinic/Hospital:Optional",
      "Trading/Distribution:Recommended",
      "Manufacturing:Recommended",
      "Enterprise:Required",
    ],
    dependencies: [
    ...
    capabilities: [
      ...
      "Annual, branch, department, project budgets",
      "Commitment control",
    ...
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-41-Budgeting-Financial-Control.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
  },
  {
    moduleCode: "MOD-42",
    numericId: "42",
    moduleName: "Manufacturing, BOM, Production & Costing",
    displayName: "Manufacturing, BOM, Production & Costing",
    moduleGroup: "Business Operations",
    coreModule: false,
    status: "Inactive",
    description:
      "BOM, production orders, material issue/return, WIP, finished goods, wastage, labor/overhead, batch and product costing",
    implementationStatus: "Planned",
    documentationStatus: "ARCHITECTURE APPROVED",
    editionAvailability: [
      "Manufacturing:Required",
    ...
    capabilities: [
      ...
      "Wastage, labor cost, overhead allocation",
      "Batch costing and product costing",
    ],
    supportedLocales: ["en-BD", "bn-BD", "ar-SA", "ur-PK", "hi-IN"],
    docPath: "docs/modules/MOD-42-Manufacturing-Costing.md",
    automatedQcStatus: "NOT RUN",
    manualQcStatus: "NOT RUN",
    browserUatStatus: "NOT RUN",
    productionApprovalStatus: "Not Approved",
