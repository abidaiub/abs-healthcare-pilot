...
export const HOST_SERVICES: HostServiceSeed[] = [
  ...
  },
  {
    ...
    resultMode: "NUMERIC",
    parameters: [
      { parameterCode: "ESR", parameterName: "ESR", unit: "mm/1st hour", resultType: "NUMERIC", displayOrder: 1, isRequired: true },
    ],
  },
  {
    serviceCode: "HBA1C",
    serviceName: "Glycated Haemoglobin (HbA1c)",
    shortName: "HbA1c",
    deptCode: "LAB",
    categoryCode: "BIO",
    basePrice: 750,
    ...
    resultMode: "NUMERIC",
    parameters: [
      { parameterCode: "HBA1C", parameterName: "HbA1c", unit: "%", resultType: "NUMERIC", displayOrder: 1, isRequired: true },
    ],
  },
  {
    serviceCode: "UREA",
    serviceName: "Serum Urea",
    shortName: "Urea",
    deptCode: "LAB",
    categoryCode: "BIO",
    basePrice: 300,
    ...
    resultMode: "NUMERIC",
    parameters: [
      { parameterCode: "UREA", parameterName: "Serum Urea", unit: "mg/dL", resultType: "NUMERIC", displayOrder: 1, isRequired: true },
    ],
  },
  {
    serviceCode: "ELECTRO",
    ...
    resultMode: "NUMERIC",
    parameters: [
      { parameterCode: "NA", parameterName: "Sodium (Na+)", unit: "mmol/L", resultType: "NUMERIC", displayOrder: 1, isRequired: true },
      { parameterCode: "K", parameterName: "Potassium (K+)", unit: "mmol/L", resultType: "NUMERIC", displayOrder: 2, isRequired: true },
      { parameterCode: "CL", parameterName: "Chloride (Cl-)", unit: "mmol/L", resultType: "NUMERIC", displayOrder: 3, isRequired: true },
    ],
  },
  {
    serviceCode: "FT4",
    ...
    resultMode: "NUMERIC",
    parameters: [
      { parameterCode: "FT4", parameterName: "Free T4", unit: "ng/dL", resultType: "NUMERIC", displayOrder: 1, isRequired: true },
    ],
  },
  {
    serviceCode: "PREG",
    serviceName: "Pregnancy Test (Urine hCG)",
    shortName: "Pregnancy Test",
    deptCode: "LAB",
    categoryCode: "CLP",
    basePrice: 300,
    sampleTypeCode: "URINE",
    ...
    testMethodCode: "MANUAL",
    resultMode: "TEXT",
    specimenInstruction: "First morning urine sample preferred.",
    parameters: [
      { parameterCode: "HCG", parameterName: "Urine hCG", resultType: "TEXT", displayOrder: 1, isRequired: true },
    ],
  },
  {
    serviceCode: "BCS",
