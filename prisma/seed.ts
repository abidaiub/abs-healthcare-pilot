...
import { seedVerificationFoundation } from "./seed/verification-foundation";
...
async function main() {
  ...
  await seedLabFoundation(prisma, tenant.tenantCode);
  ...
  await seedVerificationFoundation(prisma, tenant.id, branch.id);
